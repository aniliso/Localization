...
@section('content')
    {!! Form::open(['route' => ['admin.localization.district.update', $district->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('localization::admin.districts.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
